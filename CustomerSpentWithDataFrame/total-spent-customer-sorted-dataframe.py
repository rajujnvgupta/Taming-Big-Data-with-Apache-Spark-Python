...
customersDF = spark.read.schema(customerOrderSchema).csv("/home/raju/Desktop/Taming-Big-Data-with-Apache-Spark-Python/CustomerSpentWithDataFrame/customer-orders.csv")
