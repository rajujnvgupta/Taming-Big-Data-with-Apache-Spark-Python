...
def loadMovieNames():
    ...
    with codecs.open("/home/raju/Desktop/Taming-Big-Data-with-Apache-Spark-Python/SparkClusterMoviesSimilar/ml-100k/u.item", "r", encoding='ISO-8859-1', errors='ignore') as f:
        for line in f:
            fields = line.split('|')
...
ratings = spark.read.option("sep", "\t").schema(moviesSchema) \
    .csv("/home/raju/Desktop/Taming-Big-Data-with-Apache-Spark-Python/SparkClusterMoviesSimilar/ml-100k/u.data")
