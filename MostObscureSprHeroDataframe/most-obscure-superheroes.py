...
names = spark.read.schema(schema).option("sep", " ").csv("/home/raju/Desktop/Taming-Big-Data-with-Apache-Spark-Python/MostObscureSprHeroDataframe/Marvel_Names")

lines = spark.read.text("/home/raju/Desktop/Taming-Big-Data-with-Apache-Spark-Python/MostObscureSprHeroDataframe/Marvel_Graph")
